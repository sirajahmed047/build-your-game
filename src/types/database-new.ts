...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      activate_premium: {
        Args: { days: number; payment_uuid: string; user_uuid: string }
        Returns: boolean
      }
      activate_user_premium: {
        Args: { days: number; package_type_param: string; user_uuid: string }
        Returns: boolean
      }
      ...
      get_user_premium_days_remaining: {
        Args: { user_uuid: string }
        Returns: number
      }
